...
export const INITIALIZE_USER_ACCESS       = 'INITIALIZE_USER_ACCESS';
export const CLEANUP_USER_ACCESS          = 'CLEANUP_USER_ACCESS';
export const INITIALIZE_USER_EVENT_DATA   = 'INITIALIZE_USER_EVENT_DATA';
export const CLEANUP_USER_EVENT_DATA      = 'CLEANUP_USER_EVENT_DATA';
export const UPDATE_CURRENT_EVENT         = 'UPDATE_CURRENT_EVENT';
export const UPDATE_USER_EVENT_DATA       = 'UPDATE_USER_EVENT_DATA';
...
export const REQUEST_EVENT_ACCESS         = 'REQUEST_EVENT_ACCESS';
export const UPDATE_USER_EVENT_ACCESS_REQ = 'UPDATE_USER_EVENT_ACCESS_REQ';
export const RESET_USER_EVENT_DATA        = 'RESET_USER_EVENT_DATA';
...
export const REGISTER_DONE_LOADING        = 'REGISTER_DONE_LOADING';

//UserScreen
export const USER_SCREEN_LOADING          = 'USER_SCREEN_LOADING';
export const USER_SCREEN_DONE_LOADING     = 'USER_SCREEN_DONE_LOADING';